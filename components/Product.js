...
const Product = ({ post }) => {
  ...
  // fetch the cart to handle button
  ...
  return (
    <div className="flex flex-col justify-between itmes-center hover:scale-110 transition duration-300 ease-in gap-3 p-4 mt-10 ml-5 rounded-xl shadow-xl hover:shadow-2xl bg-slate-50">
      <div>
      ...
      <div className="flex justify-between gap-12 items-center w-full mt-5">
        ...
        {
          // humne jo bhi cart ke andr dala hai agr uski id brabr hogye post ki id se to iska mtlb hai phle se he insert hai vo post cart ke andr
